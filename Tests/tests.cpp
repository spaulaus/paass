...
namespace unittest_decoded_data {
    extern const unsigned int channelNumber{13};
    extern const unsigned int crateId{0};
    extern const unsigned int expected_size{1};
    extern const unsigned int ts_high{26001};
    extern const unsigned int ts_low{123456789};
    extern const unsigned int cfd_fractional_time{1234};
    extern const unsigned int slotId{2};
    extern const unsigned int energy{2345};
    extern const unsigned int ex_ts_high{26003};
    extern const unsigned int ex_ts_low{987654321};
    extern const bool cfd_forced_trigger{true};
    extern const bool cfd_source_trigger_bit{true};
    extern const bool pileup_bit{true};
    extern const bool trace_out_of_range{true};
    extern const bool virtual_channel{true};
    extern const double filterBaseline{3780.7283};

    extern const std::vector<unsigned int> energy_sums = {12, 13, 14};

    extern const std::vector<unsigned int> qdc = {123, 456, 789, 987, 654, 321, 135, 791};
    ...
    namespace R30474_250 {
        extern const double ts{111673568120085};
        extern const double ts_w_cfd{223347136240170.075317};
    }
}
...
namespace unittest_cfd_variables {
    namespace traditional {
        extern const double fraction{0.5};
        extern const unsigned int delay{2};
        extern const double phase{74.972};
    }

    namespace xia {
        extern const double fraction{0.25};
        extern const unsigned int delay{12};
        extern const double phase{0.7380742};
    }

    namespace polynomial {
        extern const double fraction{0.5};
        extern const unsigned int delay{2};
        extern const double phase{73.9898};
    }
}
...
namespace unittest_fit_variables {
    ...
    namespace pmt {
        extern const double beta{0.2659404170};
        extern const double gamma{0.2080547991796};
        extern const double phase{-0.0826487};
    }

    namespace gaussian {
        extern const double beta{1.0};
        extern const double gamma{0.0};
        extern const double phase{23.5};
    }
}
...
namespace unittest_trace_variables {
    ...
    extern const unsigned int length{2};
    extern const unsigned int gap{4};
    ...
    extern const std::pair<unsigned int, unsigned int> waveform_range(71, 86);

    extern const std::vector<double> waveform(trace_sans_baseline.begin() + waveform_range.first,
                                              trace_sans_baseline.begin() + waveform_range.second);

    extern const double waveform_qdc{21329.9};

    extern const std::vector<unsigned int> const_vector_uint = {1000, 4};
    extern const double maximum_value{3816};
    extern const unsigned int max_position{76};
    extern const std::pair<unsigned int, double> max_pair(max_position, maximum_value);

    extern const double baseline{436.7428571};
    extern const double standard_deviation{1.976184739};
    extern const std::pair<double, double> baseline_pair(baseline, standard_deviation);

    extern const unsigned int trace_delay{80};
    extern const double tail_ratio{0.2960894762};
    ...
    extern const double extrapolated_maximum = 3818.0718412264;
    extern const std::pair<unsigned int, double> extrapolated_maximum_pair(max_position, extrapolated_maximum);
}
...
namespace unittest_gaussian_trace {
    ...
    extern const unsigned int maxPosition{24};
    extern const double maxValue{79222};
    extern const std::pair<unsigned int, double> maxPair(maxPosition, maxValue);

    extern const double baseline{0.0};
    extern const double standardDeviation{0.0};
    extern const std::pair<double, double> baselinePair(baseline, standardDeviation);
    extern const double qdc{1e6};
    extern const double sigma{1.0};
}

namespace unittest_helper_functions {
    extern const std::pair<double, double> xy1(74, -729.0);
    extern const std::pair<double, double> xy2(75, 21.0);
    extern const double slope{750.0};
    extern const double intercept{-56229.0};

    extern const std::vector<unsigned int> integration_data = {0, 1, 2, 3, 4, 5};
    extern const double integral{12.5};

    extern const std::pair<unsigned int, unsigned int> qdc_pair(2, 5);
    extern const double integration_qdc{6};

    extern const std::vector<unsigned int> poly3_data(unittest_trace_variables::trace.begin() + 74,
                                                      unittest_trace_variables::trace.begin() + 78);
    extern const double poly3_maximum = unittest_trace_variables::extrapolated_maximum;

    //A vector containing the coefficients obtained from gnuplot using the data
    // from pol3_data with an x value starting at 0
    extern const std::vector<double> poly3_coeffs = {2358.0, 1635.66666666667, -516.0, 31.3333333333333};

    extern const std::vector<unsigned int> poly2_data(unittest_trace_variables::trace.begin() + 73,
                                                      unittest_trace_variables::trace.begin() + 76);
    extern const double poly2_val = 10737.0720588236;
    extern const std::vector<double> poly2_coeffs = {1122.0, 1278.5, -42.4999999999999};

    extern const unsigned int leading_edge_position{73};
    extern const double leading_edge_fraction{0.5};
    extern const double bad_fraction{-0.5};
}
